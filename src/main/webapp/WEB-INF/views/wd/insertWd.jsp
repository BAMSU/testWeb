...
홀 타입 : <input type="text" name="hallType" placeholder="하우스,호텔" required><br>
식사 가격 : <input type="text" name="mealCost" placeholder="4.7만원~8.5만원" required><br>
식사 타입 : <input type="text" name="menuType" placeholder="한식,양식" required><br>
손님 : <input type="text" name="guest" placeholder="최소40명/최대600명" required><br>
한줄 성명 : <textarea name = "ckPoint" placeholder="영국 황실풍의 스카이홀" required></textarea><br>
오시는 길 : <input type="text" name="traffic" placeholder="7호선 청담역 13번 출구 도보 10분 소요" required><br>
호선 : <input type="text" name="line" placeholder="7호선" required><br>
역 이름 : <input type="text" name="station" placeholder="청담역" required><br>
				...
				<input type="text" id="sample4_jibunAddress" placeholder="지번주소" readOnly required>
				<span id="guide" style="color: #999"></span>
				<input type="hidden" name="locationY" required>
				<input type="hidden" name="locationX" required>
				<input type="hidden" name="si" required>
				<input type="hidden" name="gu" required>
				<input type="hidden" name="dong" required>
				<input type="hidden" name="addr" required>
				<input type="hidden" name="roadAddr" required>
				<input type="submit" value="웨딩홀등록">
				</form>
</body>
</html>