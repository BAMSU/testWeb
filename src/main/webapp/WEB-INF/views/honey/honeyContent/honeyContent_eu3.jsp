...
<%@include file="/header.jsp" %>
	<section>
		<table border="1">
			<tr>
				<th colspan="4"><img style="width: 100%;"
					src="honeyimg/imgeu/paris3.jpg"></th>
			</tr>
			<tr>
				<td colspan="3" align="center"><font
					style="font-size: xx-large;"><strong>☆ 드라마 같은 파리 & 프라하 에서
							6박 7일 그 속으로 ☆ </strong></font></td>
				<td><img style="width: 100%;"
					src="http://ifamily.co.kr/image/iFamily/product_service/rehoney_detail_btn01.jpg"
					alt="상품상담문의" /></td>
			</tr>
			<tr>
				<th width="172" class="table-active">판매기간</th>
				<td width="230" style="text-align: center;">2017-11-20 ~ 2018-06-30</td>
				<th width="172" class="table-active">상품가격</th>
				<td width="230" style="text-align: center;">2,000,000원 ~
					2,260,000원</td>
			</tr>
			<tr>
				...
				<td style="text-align: center;">파리 / 프라하</td>
			</tr>
		...
		<table border="1">
			...
			<tr>
				<td><img src="honeyimg/imgeu/paris.jpg" style="width: 100%;"
					height="200"></td>
				<td>
					<TABLE id="box"
								...
								<TD
									...
									<P style="TEXT-ALIGN: left; MARGIN: 0cm 0cm 0pt"
										...
										<SPAN style="FONT-FAMILY: 돋움; FONT-SIZE: 9pt"><SPAN
											style="COLOR: #008000"><STRONG>◆ 프라하
													예정호텔&lt;준특급&gt; ◆</STRONG></SPAN><BR> <SPAN style="COLOR: #000000">
												<BR>Andel's Hotel
										</SPAN> <BR> <BR> 2002년 6월에 오픈한 현대적이고 깔끔한 디자인의 4성급 호텔, 안델스 역에서 도보이동 가능 </span>
									</P>
									
									<P style="TEXT-ALIGN: left; MARGIN: 0cm 0cm 0pt"
										class=MsoNormal align=left>
										<SPAN style="FONT-FAMILY: 돋움; FONT-SIZE: 9pt"><SPAN
											style="COLOR: #008000"><STRONG>◆ 프랑스
													예정호텔&lt;준특급&gt; ◆</STRONG></SPAN><BR> <SPAN style="COLOR: #000000">
												<BR>파리 Mercure Gare de Lyon

										</SPAN> <BR> <BR>기차와 전철을 이용할 수 있는 리옹역(Gare de Lyon) 과 같은 건물에 위치한 4성급 호텔   </span>
									</P>
								</TD>
							</TR>
						</TBODY>
			...
			<tr>
				<td
					...
					<br>3.&nbsp;프라하&nbsp;왕복 항공권</font></p><p><font color="#0021b0" face="돋움체" size="2">
...
<p><font color="#0084a0"><span style="color: rgb(0, 117, 200);">
*레드비치: 피라타운-아크로티리 akrootiri행버스 종점 하차. € 1.6</span></font></p></font></font><font color="#0084a0">
<p style="font: 12px/18px 돋움, Dotum, Helvetica, sans-serif; margin: 0px; padding: 0px; color: rgb(0, 0, 0); text-transform: none; 
text-indent: 0px; letter-spacing: normal; word-spacing: 0px; white-space: normal; -ms-word-break: break-all; font-size-adjust: none; font-stretch: normal;
 -webkit-text-stroke-width: 0px;">&nbsp;</p><p>&nbsp;</p></font><p style="font: 12px/18px 돋움, Dotum, Helvetica, sans-serif; margin: 0px; padding: 0px; 
 color: rgb(0, 0, 0); text-transform: none; text-indent: 0px; letter-spacing: normal; word-spacing: 0px; white-space: normal; -ms-word-break: break-all; 
 font-size-adjust: none; font-stretch: normal; -webkit-text-stroke-width: 0px;"><strong>▶ 5 일 ◀ 산토리니 / 아테네 </strong></p><p>숙소 조식 후 아테네 항공이동</p>
 <p><strong><font color="#ff6600">▒  추천일정 ▒</font></strong><br>신타그마 광장: 옴모니아 광장까지 이어지는 길에는 아테네를 대표하는 유서<br>깊은 건물들이 자리하고 
있다.<br>에르무거리: 쇼핑하기 가장 좋은 곳으로 알려진 거리 <br><br>
</p><p><span style="color: rgb(0, 117, 200);">*아크로폴리스: € 12(성인), € 6(학생) - 아크로폴리스 박물관 입장 포함)</span></p>
<p>&nbsp;</p><font color="#0084a0" face="Dotum"><p style="font: 12px/18px 돋움, Dotum, Helvetica, sans-serif; margin: 0px; padding: 0px; color: rgb(0, 0, 0); 
text-transform: none; text-indent: 0px; letter-spacing: normal; word-spacing: 0px; white-space: normal; -ms-word-break: break-all; font-size-adjust: none; 
font-stretch: normal; -webkit-text-stroke-width: 0px;"><strong><br></strong></p><p style="font: 12px/18px 돋움, Dotum, Helvetica, sans-serif; margin: 0px; 
padding: 0px; color: rgb(0, 0, 0); text-transform: none; text-indent: 0px; letter-spacing: normal; word-spacing: 0px; white-space: normal; -ms-word-break:
 break-all; font-size-adjust: none; font-stretch: normal; -webkit-text-stroke-width: 0px;"><strong>▶ 6 일 ◀ 아테네&nbsp;</strong></p>
 <p style="font: 12px/18px 돋움, Dotum, Helvetica, sans-serif; margin: 0px; padding: 0px; color: rgb(0, 0, 0); text-transform: none; text-indent: 0px;
  letter-spacing: normal; word-spacing: 0px; white-space: normal; -ms-word-break: break-all; font-size-adjust: none; font-stretch: normal; -webkit-text-stroke-width: 0px;">
  숙소 조식 후 자유여행</p><p style="font: 12px/18px 돋움, Dotum, Helvetica, sans-serif; margin: 0px; padding: 0px; color: rgb(0, 0, 0); text-transform: none; text-indent: 0px; 
  letter-spacing: normal; word-spacing: 0px; white-space: normal; -ms-word-break: break-all; font-size-adjust: none; font-stretch: normal; -webkit-text-stroke-width: 0px;">
  <strong><font color="#ff6600">▒  
  추천일정 ▒<br></font></strong>아크로폴리스: 디오니소스 극장, 프로필레드, 아테나 니케 신전, 에렉테이온, <br>파르테논 신전, 
  아크로폴리스 박물관 등 <br>고대아고라:  헤파이토스 신전, 아탈로스 주랑 등</p><p style="font: 12px/18px 돋움, Dotum, Helvetica, sans-serif;
   margin: 0px; padding: 0px; color: rgb(0, 0, 0); text-transform: none; text-indent: 0px; letter-spacing: normal; word-spacing: 0px; 
   white-space: normal; -ms-word-break: break-all; font-size-adjust: none; font-stretch: normal; -webkit-text-stroke-width: 0px;">&nbsp;</p>
   <p style="font: 12px/18px 돋움, Dotum, Helvetica, sans-serif; margin: 0px; padding: 0px; color: rgb(0, 0, 0); 
   text-transform: none; text-indent: 0px; letter-spacing: normal; word-spacing: 0px; white-space: normal; -ms-word-break: break-all; 
   font-size-adjust: none; font-stretch: normal; -webkit-text-stroke-width: 0px;"><strong><font color="#79c101" face="돋움체">▒&nbsp;이동여정 ▒</font></strong></p>
   <p style="font: 12px/18px 돋움, Dotum, Helvetica, sans-serif; margin: 0px; padding: 0px; color: rgb(0, 0, 0); text-transform: none; text-indent: 0px; letter-spacing: normal; word-spacing: 0px; white-space: normal; -ms-word-break: break-all; font-size-adjust: none; font-stretch: normal; -webkit-text-stroke-width: 0px;">항공 출발 3시간 전까지 아테네 국제&nbsp;공항으로 이동</p><p style="font: 12px/18px 돋움, Dotum, Helvetica, sans-serif; margin: 0px; padding: 0px; color: rgb(0, 0, 0); text-transform: none; text-indent: 0px; letter-spacing: normal; word-spacing: 0px; white-space: normal; -ms-word-break: break-all; font-size-adjust: none; font-stretch: normal; -webkit-text-stroke-width: 0px;">[EK 323 23시 55분] 아테네 공항 출발</p></font><p>&nbsp;</p><font color="#0084a0"><p>&nbsp;</p></font><p style="font: 12px/18px 돋움, Dotum, Helvetica, sans-serif; margin: 0px; padding: 0px; color: rgb(0, 0, 0); text-transform: none; text-indent: 0px; letter-spacing: normal; word-spacing: 0px; white-space: normal; -ms-word-break: break-all; font-size-adjust: none; font-stretch: normal; -webkit-text-stroke-width: 0px;"><strong>▶ 6 일 ◀ 두바이 / 인천</strong></p><p style="font: 12px/18px 돋움, Dotum, Helvetica, sans-serif; margin: 0px; padding: 0px; color: rgb(0, 0, 0); text-transform: none; text-indent: 0px; letter-spacing: normal; word-spacing: 0px; white-space: normal; -ms-word-break: break-all; font-size-adjust: none; font-stretch: normal; -webkit-text-stroke-width: 0px;">[04시 25분] 두바이 도착</p><p style="font: 12px/18px 돋움, Dotum, Helvetica, sans-serif; margin: 0px; padding: 0px; color: rgb(0, 0, 0); text-transform: none; text-indent: 0px; letter-spacing: normal; word-spacing: 0px; white-space: normal; -ms-word-break: break-all; font-size-adjust: none; font-stretch: normal; -webkit-text-stroke-width: 0px;">[EK 105 10시 05분] 두바이 공항 출발</p><p style="font: 12px/18px 돋움, Dotum, Helvetica, sans-serif; margin: 0px; padding: 0px; color: rgb(0, 0, 0); text-transform: none; text-indent: 0px; letter-spacing: normal; word-spacing: 0px; white-space: normal; -ms-word-break: break-all; font-size-adjust: none; font-stretch: normal; -webkit-text-stroke-width: 0px;">[14시 05분] 인천국제공항 도착</p><p style="font: 12px/18px 돋움, Dotum, Helvetica, sans-serif; margin: 0px; padding: 0px; color: rgb(0, 0, 0); text-transform: none; text-indent: 0px; letter-spacing: normal; word-spacing: 0px; white-space: normal; -ms-word-break: break-all; font-size-adjust: none; font-stretch: normal; -webkit-text-stroke-width: 0px;">&nbsp;</p></td>
		...
		<table border="1">
			<tr>
				<td width="235"><a href="countryContent.we?country=france">
						<img src="honeyimg/imgeu/paris2.jpg" width="235" height="100" />
				</a></td>
				<td width="170">
					<div
						onclick="javascript:location.href='countryContent.we?country=france'"
						style="cursor: pointer;">
						<font size="5" color="#F29661">프랑스<br></font> <font size="4">
							지역정보<br> 보러가기
						</font> <em> <img
				...
				<td width="235"><a href="countryContent.we?country=praha"> <img
						src="honeyimg/imgeu/praha2.jpg"
						width="235" height="100" />
				</a></td>
				<td width="170">
					<div
						onclick="javascript:location.href='countryContent.we?country=praha'"
						style="cursor: pointer;">
						<font size="5" color="#F29661">체코 <br></font><font size="4">지역 정보<br>보러가기
						</font> <em> <img
							src="http://ifamily.co.kr/image/iFamily/product_service/rehoney_detail_arrow02_ico.png" />
						</em>
					</div>
