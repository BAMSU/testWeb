...
<body>
	<table>
		<tr>
			<td>
<img src="selectedhoju.jpg" usemap="#worldmap" width="800px;"> <map
	...
	<table id="plist">
	<tr><td><div>
					<a href="honeyContent/honeyContent_hoju1.jsp"> <img
						src="imghoju/호주1.jpg">
					</a>
				</div>
				<div
					onclick="javascript:location.href='honeyContent/honeyContent_hoju1.jsp'"
				...
				<td><div>
					<a href="honeyContent/honeyContent_hoju2.jsp"> <img
						src="imghoju/호주4.jpg">
					</a>
				</div>
				<div
					onclick="javascript:location.href='honeyContent/honeyContent_hoju2.jsp'"
					style="cursor: pointer; padding-left: 10px; padding-top: 5px; padding-bottom: 5px;">
					<font size="2">시드니 골드코스트 / 호주 <br> 5박 7일 by LotteGG
					</font><br>
				</div>
