...
<div>
	...
	<div = class="right">
		<input type="button" class="darkGrey rounded" value="선택" onclick="sel(0)">
	</div>
</div>
<br><hr>
<div>
	...
	<div = class="right">
	<input type="button" class="darkGrey rounded" value="선택" name=1 onclick="sel(1)">
	</div>
</div>
<br><hr>
<div>
...
오셔서 축복해 주시기 바랍니다.
	...
	<div = class="right">
	<input type="button" class="darkGrey rounded" value="선택" name=2 onclick="sel(2)">
	</div>
</div>
<br><hr>
<div>
...
부디 오셔서 지켜봐 주시기 바랍니다.
	...
	<div = class="right">
	<input type="button" class="darkGrey rounded" value="선택" name=3 onclick="sel(3)">
	</div>
</div>
<br><hr>
<div>
...
더욱 빛내 주시길 바라옵니다.
	...
	<div = class="right">
	<input type="button"  class="darkGrey rounded" value="선택" name=4 onclick="sel(4)">
	</div>
</div>
<br><hr>
<div>
...
훤히 밝혀 주옵소서.
	...
	<div = class="right">
	<input type="button" class="darkGrey rounded" value="선택" name=5 onclick="sel(5)">
	</div>
</div>
<br><hr>
<div>
	...
	<div = class="right">
	<input type="button"  class="darkGrey rounded"value="선택" name=6 onclick="sel(6)">
	</div>
</div>
<br><hr>
...
함께 나아가는 삶을 꾸리겠습니다.
	...
	<div = class="right">
	<input type="button" class="darkGrey rounded" value="선택" name=7 onclick="sel(7)">
	</div>
</div>
<br><hr>
...
삼가 아뢰오니 축복해 주시기 바랍니다.
	...
	<div = class="right">
	<input type="button" class="darkGrey rounded" value="선택" name=8 onclick="sel(8)">
	</div>
</div>
<br><hr>
...
보다 힘찬 내디딤이 될 것입니다.
	...
	<div = class="right">
	<input type="button" class="darkGrey rounded" value="선택" name=9 onclick="sel(9)">
	</div>
</div>
<br><hr>
...
앞날을 축복해주시면 더욱 감사하겠습니다. 
	...
	<div = class="right">
	<input type="button" class="darkGrey rounded" value="선택" name=10 onclick="sel(10)">
	</div>
</div>
<br><hr>
...
축복해주십시오
	...
	<div = class="right">
	<input type="button"  class="darkGrey rounded" value="선택" name=11 onclick="sel(11)">
	</div>
</div>
<br><hr>
...
저희 두사람의 서약의 날 ! 
	...
	<div = class="right">
	<input type="button" class="darkGrey rounded" value="선택" name=12 onclick="sel(12)">
	</div>
</div>
<br><hr>
<div>
...
더없이 기쁨으로 소중히 간직하겠습니다. 
	...
	<div = class="right">
	<input type="button"  value="선택" class="darkGrey rounded" name=13 onclick="sel(13)">
	</div>
</div>
<br><hr>
