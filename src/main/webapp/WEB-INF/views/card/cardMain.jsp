...
<ul class="nav nav-tabs">
			  <li class="topMenuLi">
			    <a class="menuLink" data-toggle="tab" href="cardList.we?type=1">인기순</a>
			  </li>
			  <li class="topMenuLi">
			    <a class="menuLink" data-toggle="tab" href="cardList.we?type=2">최신순</a>
			  </li>
			  <li class="topMenuLi">
			    <a class="menuLink" data-toggle="tab" href="cardList.we?type=3">낮은가격순</a>
			  </li>
			  <li class="topMenuLi">
			    <a class="menuLink" data-toggle="tab" href="cardList.we?type=4">높은가격순</a>
			  </li>
			</ul>
