  ...
  <c:forEach var="i" items="${list}" >
		 <a href="cardMake.we?idx=${i.card_idx }"><div class="gallery_content">
           <img src="card_img/${i.card_img}" width="300px" height="150px">
            <div class="content">
                <p style="font-size: 20px; color: white;"><strong>${i.card_name }</strong></p>
                <p style="font-size: 13px; color: white;"><strong>${i.card_price }원</strong></p>
            </div>
            <div class="overlay darkBlue"></div>
        </div></a>
  </c:forEach>
  </div>
<div id="page" style="text-align: center; width: 100%; margin-top: 500px;">${pageStr}</div>
