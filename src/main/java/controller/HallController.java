...
public class HallController {
	...
	public ModelAndView hallInfoForm(@RequestParam(value="idx",defaultValue="1")int idx,
		...
		mav.addObject("reviewList",reviewDao.ReviewList(cp, 5, h.getName()));
		mav.addObject("pageStr",PageModule.makePage("hallInfo.we", reviewDao.getNameTotelCont(h.getName()), 5, 5, cp));
